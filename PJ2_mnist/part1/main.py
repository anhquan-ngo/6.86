...
#     return test_error
#
# print('Error rate:', run_softmax_on_MNIST_mod3(temp_parameter=1))
#
#
...
# print('Error rate of softmax using PCA inputs:', test_error_pca)
...
# theta, cost_function_history = softmax_regression(train_cube, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4,
#                                                       k=10, num_iterations=150)
# test_error_cube = compute_test_error(test_cube, test_y, theta, temp_parameter)

clf = SVC(random_state=0, kernel = 'poly', degree = 3)
clf_rbf = SVC(random_state = 0, kernel = 'rbf')
clf.fit(train_pca10, train_y)
clf_rbf.fit(train_pca10, train_y)
pred_test_y = clf.predict(test_pca10)
pred_test_y_rbf = clf_rbf.predict(test_pca10)
test_error_cube = compute_test_error_svm(test_y, pred_test_y)
test_error_cube_rbf = compute_test_error_svm(test_y, pred_test_y_rbf)
print('Error rate of using svm with 10-dim cubic PCA as inputs:', test_error_cube, test_error_cube_rbf)
